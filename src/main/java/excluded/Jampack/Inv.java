...
public class Inv {
     ...
     * @throws JampackException Thrown if L is not square.<br>
     *                          Passed from below.
     */
     ...
     * @throws JampackException Thrown if U is not square.<br>
     *                          Passed from below.
     */
     ...
     * @throws JampackException Thrown if A is not square.<br>
     *                          Passed from below.
     */
     ...
     * @throws JampackException Thrown if D singular.
     */
